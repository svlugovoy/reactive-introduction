package com.svlugovoy.reactiveintroduction;

import com.svlugovoy.reactiveintroduction.domain.Person;
import com.svlugovoy.reactiveintroduction.domain.PersonDTO;
...
public class ReactiveExamplesTest {
    ...
    public void monoTransform() throws Exception {
        ...
        PersonDTO dto = personMono
                .map(person -> { //type transformation
                    return new PersonDTO(person);
                }).block();

        log.info(dto.sayMyName());
    }
